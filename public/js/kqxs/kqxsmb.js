      ...
      fetch(`${baseUrl}${currentPage}`, {
        ...
        .then((html) => {
          if (html && html.trim().length > 0) {
            ...
            // Find new articles in response
            const newArticles = doc.querySelectorAll("article.my-2");
            
            if (newArticles.length > 0) {
              // Insert new articles at the end of container
              const container = document.getElementById("ajax_content");
              ...
              // No more results
              this.disabled = true;
              this.textContent = "Không còn kết quả";
            }
          } else {
            // Empty response
            this.disabled = true;
        ...
        .catch((error) => {
          ...
          this.disabled = false;
          this.textContent = originalText;
          alert("Có lỗi xảy ra khi tải thêm kết quả. Vui lòng thử lại.");
        });
    });
  }
});
