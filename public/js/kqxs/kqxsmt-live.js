...
// Tìm tất cả các bảng kết quả XSMT
const tables = document.querySelectorAll('.table-result[data-code="XSMT"]');
...
console.log('provinceIdToKeyId', provinceIdToKeyId);
...
function connectWebSocket() {
    ...
    const win = getWindowFor(now);
    if (!withinWindow(now, win)) {
        console.log('Not within live window, skipping connection');
        return;
    }
